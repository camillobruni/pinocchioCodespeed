...
>>>>>>> master
    ...
    branch   = models.CharField(max_length=200, default='trunk')
...
class Executable(models.Model):
    ...
    coptions = models.CharField("compile options", max_length=200, blank=True)
    project  = models.ForeignKey(Project)
...
class Benchmark(models.Model):
    ...
    units          = models.CharField(max_length=100, default='seconds')
...
class Environment(models.Model):
    ...
    kernel = models.CharField(max_length=200, blank=True)
